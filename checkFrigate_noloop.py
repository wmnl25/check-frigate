...
REFERENCE_IMAGE_PATH = "/root/check-frigate/latest.webp"  # Local uploaded image
...
def check_images():
    print("[STARTING] Checking images...")
    reference_image = Image.open(REFERENCE_IMAGE_PATH)

    print("[INFO] Checking first image...")
    first_image = download_image(URL)
    if first_image is None:
        print("[WARNING] Could not fetch the first image. Exiting...")
        return
